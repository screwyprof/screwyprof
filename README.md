...
I architect complex business domains — DDD, CQRS, event-driven — into backends that stay legible as they grow and hold up in production. I've taken fragile financial, e-commerce, and blockchain systems and made them scale predictably and recover on their own, pairing deep engineering discipline with simple design. I set technical direction as a hands-on IC: standards, RFCs/ADRs, and CI gates, not headcount.
...
Open to **senior and staff** backend & distributed-systems roles — architecting complex domains, reliability, and scale. **Remote-only**, hands-on IC, **no people management**.
